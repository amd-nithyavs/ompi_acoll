...
typedef int (*bcast_subc_func)(void *buff, int count, struct ompi_datatype_t *datatype, int root,
 ...
 *              "basic" component.
 */
static int bcast_binomial(void *buff, int count, struct ompi_datatype_t *datatype, int root,
                          struct ompi_communicator_t *comm, ompi_request_t **preq, int *nreqs,
                          int world_rank)
{
...
static int bcast_flat_tree(void *buff, int count, struct ompi_datatype_t *datatype, int root,
                           struct ompi_communicator_t *comm, ompi_request_t **preq, int *nreqs,
                           int world_rank)
{
    int peer;
...
static int mca_coll_acoll_bcast_intra_node(void *buff, int count, struct ompi_datatype_t *datatype,
